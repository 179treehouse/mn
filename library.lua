    ...
    Library = {
        ...
        do
            ...
            Library.Watermark = function(Self, Params)
                ...
                function Watermark:Center() end
                function Watermark:SetText(Text) end
                function Watermark:SetSubText(Text) end
                function Watermark:SetVisibility(Bool) end
            ...
            Library.InitWindow = function(Self)
                local SettingsPage = Self:Page({Name = "config"}) do
                    -- enforce fixed animation settings
                    Library.Animation.Style = "Linear"
                    Library.Animation.Direction = "In"
                    Library.Animation.Time = 0.1
                    ...
                    local ThemingSection = SettingsPage:Section({Name = "theme", Side = 1}) do
                    ...
                    -- 'other' section removed; animation settings enforced above
                end
            end
        end
    end
